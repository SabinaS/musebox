...
initial
   begin
     ...
     fftpts_array[0]=32768;
     fftpts_array[1]=32768;
     fftpts_array[2]=32768;
     fftpts_array[3]=32768;
     ...
     fft_if =$fopen("fft_module_imag_output_ver.txt");
     expf = $fopen("fft_module_exponent_output_ver.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
